...
export const CONFIG = {
    ...
    ASTEROIDES: {
        small:           { RADIO: 16, ESCALA: 0.16, VELOCIDAD: 150, SALUD: 25,  PUNTOS: 30,  DANO: 10, CARGA_ULTI: 5 },
        medium:          { RADIO: 32, ESCALA: 0.32, VELOCIDAD: 100, SALUD: 50,  PUNTOS: 20,  DANO: 25, CARGA_ULTI: 5 },
        large:           { RADIO: 64, ESCALA: 0.64, VELOCIDAD: 50,  SALUD: 75,  PUNTOS: 10,  DANO: 50, CARGA_ULTI: 5 },
        special:         { RADIO: 48, ESCALA: 0.48, VELOCIDAD: 120, SALUD: 200, PUNTOS: 100, DANO: 0,  CARGA_ULTI: 0 },
        large_rezagado:  { RADIO: 64, ESCALA: 0.64, VELOCIDAD: 60,  SALUD: 75,  PUNTOS: 10,  DANO: 50, CARGA_ULTI: 5 },
        medium_rezagado: { RADIO: 32, ESCALA: 0.32, VELOCIDAD: 80,  SALUD: 50,  PUNTOS: 20,  DANO: 25, CARGA_ULTI: 5 },
        small_rezagado:  { RADIO: 16, ESCALA: 0.16, VELOCIDAD: 120, SALUD: 25,  PUNTOS: 30,  DANO: 10, CARGA_ULTI: 5 },
    },
    ...
    NAVE_ENEMIGA: {
        ...
        CARGA_ULTI: 10,                 // Carga de ulti que da al destruirla
        VELOCIDAD: 225,                 // px/s
        RADIO_COLISION: 15,
